...
import com.example.flickerdemoapp.ui.PhotoAdapter
...
class SearchActivity : BaseActivity() {
    ...
    private fun setListener() {
        search_recycler_view.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                println("$currentItems $totalItems ${firstVisibleItems?.size} $scrollOutItems")
    ...
    private fun init() {
        ...
        viewModel?.photoList?.observe(this, Observer {
            ...
            println("list size " + listOfPhotos.size)
